...
public class DaoAspect {
    //定义公共切点
    @Pointcut("execution(* com.aop.demo02.*.add*(..))")
    ...
    * */
    ...
    public void methodBefore(JoinPoint joinPoint){
        System.out.println("aaa Before invoked");
    }
    /*
    * 后置通知:方法执行之后要增强的功能
    * 无论切点方法是否出现异常都会执行的方法
    ...
    * */
    ...
    public void methodAfter(JoinPoint joinPoint){
        System.out.println("aaa After invoked");
    }
    /*
    ...
    public void methodAfterReturning(JoinPoint joinPoint,Object res){
        System.out.println(" aaa AfterReturning invoked");
    }
    /*
    ...
    public void methodAfterThrowing(Exception ex){
        System.out.println("aaa AfterThrowing invoked");
    }
    ...
    * */
    ...
    public Object methodAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        System.out.println("aaa  aroundA invoked");
        Object proceed = proceedingJoinPoint.proceed();
        System.out.println("aaa aroundB invoked");
        return proceed;
    }
}